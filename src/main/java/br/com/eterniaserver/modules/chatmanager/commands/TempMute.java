                ...
                if (args.length == 3) {
                    ...
                    if (target != null && target.isOnline()) {
                        try {
                            ...
                            messages.BroadcastMessage("chat.mutetbroad", "%player_name%", target.getName(), "%time%", time, "%message%", args[2]);
            ...
            if (args.length == 3) {
                ...
                if (target != null && target.isOnline()) {
                    try {
                        ...
                        messages.BroadcastMessage("chat.mutetbroad", "%player_name%", target.getName(), "%time%", time, "%message%", args[1]);
