...
public class Table {
    ...
    public Table() {
        ...
        if (EterniaLib.getMySQL()) {
            ...
            EQueries.executeQuery(Constants.getQueryCreateTable(Configs.tablePlayer, "(uuid varchar(36), player_name varchar(16), time bigint(20), last bigint(20), hours int(11))"), false);
            ...
            EQueries.executeQuery(Constants.getQueryCreateTable(Configs.tablePlayer, "(uuid varchar(36), player_name varchar(16), time integer, last integer, hours int(11))"), false);
        ...
        EQueries.executeQuery(Constants.getQueryCreateTable(Configs.tableNick, "(uuid varchar(36), player_display varchar(16))"), false);
