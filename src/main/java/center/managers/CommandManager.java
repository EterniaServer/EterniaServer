...
import center.Main;
import center.Vars;
import commands.experience.Bottlexp;
import commands.experience.CheckLevel;
import commands.experience.DepositLevel;
import commands.experience.WithdrawLevel;
import commands.messages.*;
import commands.others.*;
import commands.teleports.*;
import java.util.Objects;

public class CommandManager {
    public CommandManager(Main plugin) {
        if (Vars.getBool("modules.generic")) {
